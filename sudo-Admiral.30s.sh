...
# ── traduzioni ──
case "$lang" in
 en) t_open="Unlock fleet"; t_close="Lock fleet"; t_timeout="Idle timeout"; t_min="min"; t_prefs="Preferences"; t_lang="Language"; t_about="About sudo-Admiral"; t_quit="Quit sudo-Admiral"; t_author="Author"; t_engine="Engine"; t_desc="passwordless sudo lock across the whole fleet"; w_open="unlocked"; w_closed="locked"; w_manage="manageable (SSH)"; w_unreach="unreachable";;
 es) t_open="Desbloquear flota"; t_close="Bloquear flota"; t_timeout="Tiempo de inactividad"; t_min="min"; t_prefs="Preferencias"; t_lang="Idioma"; t_about="Acerca de sudo-Admiral"; t_quit="Salir de sudo-Admiral"; t_author="Autor"; t_engine="Motor"; t_desc="bloqueo sudo sin contraseña en toda la flota"; w_open="desbloqueado"; w_closed="bloqueado"; w_manage="gestionable (SSH)"; w_unreach="inaccesible";;
 fr) t_open="Déverrouiller la flotte"; t_close="Verrouiller la flotte"; t_timeout="Délai d'inactivité"; t_min="min"; t_prefs="Préférences"; t_lang="Langue"; t_about="À propos de sudo-Admiral"; t_quit="Quitter sudo-Admiral"; t_author="Auteur"; t_engine="Moteur"; t_desc="verrou sudo sans mot de passe sur toute la flotte"; w_open="déverrouillé"; w_closed="verrouillé"; w_manage="gérable (SSH)"; w_unreach="injoignable";;
 de) t_open="Flotte entsperren"; t_close="Flotte sperren"; t_timeout="Leerlauf-Timeout"; t_min="Min."; t_prefs="Einstellungen"; t_lang="Sprache"; t_about="Über sudo-Admiral"; t_quit="sudo-Admiral beenden"; t_author="Autor"; t_engine="Engine"; t_desc="passwortloses sudo-Schloss für die gesamte Flotte"; w_open="entsperrt"; w_closed="gesperrt"; w_manage="verwaltbar (SSH)"; w_unreach="nicht erreichbar";;
 zh) t_open="解锁全部设备"; t_close="锁定全部设备"; t_timeout="空闲超时"; t_min="分钟"; t_prefs="偏好设置"; t_lang="语言"; t_about="关于 sudo-Admiral"; t_quit="退出 sudo-Admiral"; t_author="作者"; t_engine="引擎"; t_desc="对整个设备群的免密 sudo 锁"; w_open="已解锁"; w_closed="已锁定"; w_manage="可管理 (SSH)"; w_unreach="无法访问";;
 *)  t_open="Apri flotta"; t_close="Chiudi flotta"; t_timeout="Timeout inattività"; t_min="min"; t_prefs="Preferenze"; t_lang="Lingua"; t_about="Info su sudo-Admiral"; t_quit="Esci da sudo-Admiral"; t_author="Autore"; t_engine="Motore"; t_desc="lucchetto sudo senza password su tutta la flotta"; w_open="aperto"; w_closed="chiuso"; w_manage="gestibile (SSH)"; w_unreach="irraggiungibile";;
esac
